...
export function RequiredSubjectCard({ subject, uiLanguage }: RequiredSubjectCardProps) {
  return (
    <div className="flex flex-col gap-3 rounded-lg bg-surface p-4 shadow-card ring-1 ring-line">
      <div className="flex items-start justify-between gap-3">
        <SubjectIcon name={subject.icon} className="size-[18px] text-ink-muted" aria-hidden />
